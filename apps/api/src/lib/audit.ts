...
export async function audit(db: Pick<Database, 'insert'>, entry: { actorId?: string; actorRole?: string; action: string; entity: string; entityId?: string; before?: Record<string, unknown>; after?: Record<string, unknown>; reason?: string; correlationId?: string; ipHash?: string }) {
