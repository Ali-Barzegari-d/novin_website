...
export function PublicPage({ title, lead, sections, cta = true }: PublicPageProps) {
  return <>
    <section className="section page-intro"><div className="shell"><p className="eyebrow">نوین ایرانیان / زمینهٔ همکاری</p><h1>{title}</h1><p className="hero-copy">{lead}</p></div></section>
